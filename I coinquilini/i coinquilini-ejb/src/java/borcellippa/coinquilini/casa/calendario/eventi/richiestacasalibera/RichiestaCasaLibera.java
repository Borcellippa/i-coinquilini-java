...
public class RichiestaCasaLibera implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RichiestaCasaLibera)) {
            return false;
        }
        RichiestaCasaLibera other = (RichiestaCasaLibera) object;
    ...
    public String toString() {
        return "ejb.coinquilini.casa.calendario.eventi.richiestacasalibera.RichiestaCasaLibera[ id=" + id + " ]";
    }
